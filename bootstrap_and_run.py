...
# REQ_CONTENT = "fastapi\nuvicorn\nhttpx\n"
#
# # Уникальный код для каждого сервиса
...
# @app.get("/")
# async def root():
#     return {"message": "Gateway Online", "services": ["user-service", "ml-service"]}
#
# @app.get("/check-ml")
# async def check_ml():
#     async with httpx.AsyncClient() as client:
#         # Внутри сети Docker мы обращаемся по имени контейнера
#         response = await client.get("http://ml-service:8000/")
#         return {"gateway_response": "ML is alive", "ml_data": response.json()}
# """
#
...
# @app.get("/")
# def ml_root():
#     return {"status": "AI Brain Active", "model": "Reinforcement Learning v1"}
#
# @app.post("/predict")
# def predict(data: dict):
#     return {"prediction": "Success", "action": "STAY_PRICE"}
# """
#
...
# @app.get("/")
# def read_root():
#     return {"status": "Active", "module": "Uzun Demir Standard"}
# """
#
# # --- СТРУКТУРА ---
#
...
#
# def setup_platform():
#     print("🛠  Шаг 1: Генерация кода и структуры...")
...
#                     if "api-gateway" in folder: f.write(MAIN_PY_GATEWAY)
#                     elif "ml-service" in folder: f.write(MAIN_PY_ML)
...
#
#     print("🐳 Шаг 3: Сборка и запуск...")
#     try:
#         subprocess.run(["docker", "compose", "up", "--build", "-d"], check=True)
#         print("\n✅ ПЛАТФОРМА ОБНОВЛЕНА И ЗАПУЩЕНА!")
#         print("🔗 Главный вход: http://localhost:8000")
#         print("🔗 Проверка связи с ML: http://localhost:8000/check-ml")
